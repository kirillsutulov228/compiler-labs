...
namespace lab2.Services
{
    ...
    public class SyntaxAnalyzer
    {
        ...
        private StatementNode GetBlock()
        {
            ...
            StatementNode node = GetStatementSequense();
            CheckToken("}");
            top = table;
            return node;
        }
        ...
        private StatementNode GetStatementSequense()
        {
        ...
        private ExpressionNode BoolOr()
        {
            ...
            while (_currToken.Value == "||")
            {
                string op = _currToken.Value;
                NextToken();
                expression = new ArithmeticNode(op, expression, BoolAnd());
            }
            return expression;
        }
        private ExpressionNode BoolAnd()
        {
            ...
            while (_currToken.Value == "&&")
            {
                string op = _currToken.Value;
                NextToken();
                expression = new ArithmeticNode(op, expression, BoolMatch());
            }
            return expression;
        }
        ...
        private ExpressionNode BoolMatch()
        {
            ...
            while (_currToken.Value == "==" || _currToken.Value == ">" || _currToken.Value == "<" || _currToken.Value == "<=" || _currToken.Value == ">=" || _currToken.Value == "!=")
            {
                string op = _currToken.Value;
                NextToken();
                expression = new ArithmeticNode(op, expression, Expression());
            }
            return expression;
        }
        private ExpressionNode Expression()
        {
                ...
                _currToken.Value == "-")
            {
                string op = _currToken.Value;
                NextToken();
                expression = new ArithmeticNode(op, expression, Term());
            }
            return expression;
        }
        ...
        private ExpressionNode Term()
        {
                ...
                _currToken.Value == "/")
            {
                string op = _currToken.Value;
                NextToken();
                expression = new ArithmeticNode(op, expression, Unary());
            }
            return expression;
        }
